...
frontArrow=arrow(length=2,shaftwidth=.1,color=color.red,axis=vector(1,0,0))
upArrow=arrow(length=2.5,shaftwidth=.1,color=color.green,axis=vector(0,1,0))
sideArrow=arrow(length=2.5,shaftwidth=.1,color=color.blue,axis=vector(0,0,1))
